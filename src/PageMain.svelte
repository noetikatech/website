<script>
    ...
    import mikeHeadshot from './assets/mike_headshot.png'
...
<h1 on:mousedown={canSwitch}>What {can} we do for you?
  <br><a href= "mailto: mail@noetika.tech" on:click={cantDo}>Contact us</a>
</h1>
